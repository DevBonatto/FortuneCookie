...
const phrases = ['A vida trará coisas boas se tiver paciência.', 'Muitas das grandes realizações do mundo foram feitas por homens cansados e desanimados que continuaram o seu trabalho.', 'Você sempre será a sua melhor companhia!', 'Não compense na ira o que lhe falta na razão.', 'Aquele que se importa com o sentimento dos outros, não é um tolo.', 'A paciência na adversidade é sinal de um coração sensível.', 'Vencer é 90 por cento suor e 10 por cento de engenho.', 'A vontade das pessoas é a melhor das leis.', 'O verdadeiro homem mede a sua força, quando se defronta com o obstáculo.', 'Quem quer vencer um obstáculo deve armar-se da força do leão e da prudência da serpente.', 'Realize o óbvio, pense no improvável e conquiste o impossível.']
